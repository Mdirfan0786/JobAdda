        ...
        <div className={styles.homeContainer}>
          <div className={styles.homeContainer__leftBar}>
            <div className={styles.sideBarContainer}>
              ...
              <div
                className={`${styles.sideBarOption} ${
                  router.pathname === "/myConnections" ? styles.active : ""
                }`}
              ...
              <div
                className={`${styles.sideBarOption} ${
                  router.pathname === "/Jobs" ? styles.active : ""
                }`}
              ...
              <div
                className={`${styles.sideBarOption} ${
                  router.pathname === "/Saved_items" ? styles.active : ""
                }`}
              ...
              <div
                className={`${styles.sideBarOption} ${
                  router.pathname === "/Groups" ? styles.active : ""
                }`}
          ...
          {/* This section for mobile responsive foot */}
          <div className={styles.mobileNav}>
            <div
              className={styles.mobileNav_foot}
              onClick={() => router.push("/dashboard")}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
